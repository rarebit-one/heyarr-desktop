...
import one.rarebit.heyarr.desktop.mcp.EpisodeHit
import one.rarebit.heyarr.desktop.mcp.SearchHit
import one.rarebit.heyarr.desktop.theme.MediaType

/** A search result of any kind, flattened for keyboard navigation. */
...
object SearchGrouping {
    ...
    fun group(
        ...
        var truncated = HashSet<MediaType>()
    ...
    /** Every row in reading order — what ↑/↓ walk. */
